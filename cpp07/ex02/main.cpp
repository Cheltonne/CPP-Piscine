...
/*   Updated: 2022/09/06 11:54:34 by chajax           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	Array<int>	emptyArr;
	std::cout << "empyArr " <<
		(emptyArr.getSize() == 0 ? "is empty" : "is not empty") << '\n';

	std::cout << '\n';

	Array<int>	intArr(4);
	std::cout << "Size of intArr..." << intArr.getSize() << '\n';
	...
	Array<int>	cpyArr;
	std::cout << "Size of cpyArr..." << cpyArr.getSize() << '\n';
	std::cout << "\033[36mDeep copying intArr to cpyArr...\033[0m" << '\n';
	cpyArr = intArr;
	std::cout << "New _size of cpyArr..." << cpyArr.getSize() << '\n';
